    ...
    <div class="container d-flex align-items-center">
        ...
        <nav id="navbar" class="navbar">
            <ul>
                ...
                <li><a class="nav-link scrollto" href="<?= url("/sobre"); ?>">About Us</a></li>
                <li><a class="nav-link scrollto" href="<?= url("/servicos"); ?>">Services</a></li>
                <li><a class="nav-link scrollto" href="<?= url("/portifolio"); ?>">Portfolio</a></li>
                <li><a class="nav-link scrollto" href="<?= url("/equipe"); ?>">Team</a></li>
